...
%  with the upper triangular factors can be found as well in
%  3. Tsyganova Yu.V., Kulikova M.V. (2012) 
%     On efficient parametric identification methods for linear discrete 
%     stochastic systems, Automation and Remote Control, 73(6): 962-975.
%     DOI: http://dx.doi.org/10.1134/S0005117912060033
% ------------------------------------------------------------------- 
% Input:
...
% ------------------------------------------------------------------- 
function [neg_LLF,hatX,hatDP] = Riccati_KF_SRCF_QR(matrices,initials_filter,measurements)
